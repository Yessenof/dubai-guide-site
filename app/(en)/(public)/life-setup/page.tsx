...
const STAGES: Stage[] = [
  {
    ...
    summary:
      "Decide your visa route, start document attestation, and research schools or pets now. Most official steps happen after you land.",
    tasks: [
      ...
      { label: "Research mainland vs free zone if you are setting up a company", href: "/guides/mainland-company-setup-dubai" },
      { label: "Research schools if moving with children — check KHDA for private school options" },
  ...
  },
  {
    ...
    summary:
      "Verify your entry stamp, get a SIM card, activate DEWA, and book your Emirates ID biometrics. Do not wait on these.",
    tasks: [
      { label: "Verify your entry stamp type and validity at the airport or port of entry" },
      { label: "Get a UAE SIM card — e& (Etisalat) or du, from any mall or airport store" },
      { label: "Activate DEWA for electricity and water at your accommodation" },
      { label: "Book your Emirates ID biometrics at an Amer centre or ICA office", href: "/guides/amer-center-dubai" },
      { label: "Open a personal bank account — requirements vary by bank; book your appointment early" },
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      { label: "Activate mandatory health insurance — required in Dubai (Dubai Health Authority)" },
      { label: "Open a business bank account if you have a company licence", href: "/guides/open-business-bank-account-dubai" },
  ...
  },
  {
    ...
    summary:
      "Your first compliance deadlines arrive here. VAT threshold monitoring, Corporate Tax registration, driving licence exchange, and family visas.",
    tasks: [
      ...
      { label: "Apply for family and dependent visas if not done", href: "/guides/spouse-dependent-visa-dubai-inside-country" },
      { label: "Check Emiratisation threshold if your company has 50 or more employees", href: "/calendar/uae-emiratisation-june-30-2026-reminder" },
    ],
  ...
  },
  {
    ...
    summary:
      "Renew your visa and Emirates ID before expiry, renew your trade licence 30–60 days early, and file your Corporate Tax return within 9 months of your Tax Period.",
    tasks: [
...
const ROUTES: RouteCard[] = [
  ...
  },
  {
    ...
    description: "Founders face company setup, banking, MoHRE registration, and VAT/Corporate Tax obligations all in the first 30 days.",
    links: [
  ...
  },
  {
    ...
    description: "Landlords must register Ejari before the tenancy starts and check the Dubai rental index before any renewal. Short-term rental requires a DET permit.",
    links: [
      { label: "Holiday home permit", href: "/guides/holiday-home-permit-dubai" },
    ],
  ...
  {
    title:       "Investor",
    description: "A ready property worth AED 2,000,000 or more may qualify for a 10-year golden visa. See the full eligibility requirements in the guide.",
    links: [
  ...
  {
    title:       "Existing resident — renewal",
    description: "Visa, Emirates ID, or trade licence expiring in the next 60 days? Start the renewal process now. Do not wait until the last week.",
    links: [
      { label: "Family visa renewal",        href: "/guides/renew-family-visa-dubai" },
  ...
  return (
    <div className="max-w-2xl mx-auto px-5 py-10">
      ...
      <p className="text-[15px] text-gray-600 leading-snug mb-8">
        Know what to do before you arrive, in your first week, first 30 days, and every year after.
        Visas, company setup, Ejari, family, and property — in the right order.
      </p>
      ...
      <div className="bg-navy rounded-2xl px-5 py-5">
        ...
        <p className="text-[13px] text-white/60 mb-3">
          Ask us on WhatsApp — we help with visas, company setup, and the first steps.
        </p>
        <a
          href={WA}
          target="_blank"
