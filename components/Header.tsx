      ...
      <div className="max-w-2xl mx-auto px-5 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5 flex-shrink-0">
          ...
          <a
            ...
            className="flex-shrink-0 flex items-center gap-1 sm:gap-1.5 bg-[#25D366] text-white text-[12px] sm:text-[13px] font-semibold px-2.5 sm:px-3.5 py-2 rounded-full hover:opacity-90 transition-opacity"
          >
        ...
        <div className="flex flex-wrap items-center px-4">
          {navItems.map(({ label, href }) => (
            <Link
              key={href}
              href={href}
              className={`px-1.5 py-2 text-[14px] font-semibold whitespace-nowrap transition-colors ${
                isActive(href)
                  ? "text-gray-900"
