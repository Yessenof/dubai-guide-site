# UAE Emiratisation: MoHRE Confirms 30 June 2026 Deadline for Private-Sector Companies
...
publish_status:            published_local — pending_production_deploy
owner_review_required:     false
admin_status:              not_used
ai_inbox_status:           not_used
db_status:                 published_local — id=26cf9c7b-5480-4524-9ee3-b44837595aae
risk_level:                high
source_status:             stable_url_captured — recheck_before_publish
last_reviewed:             2026-05-20 (Phase 6C-36 — focus narrowed to 50+ employees for June 30 deadline; 20–49 band softened to cautious mention)

phase_6c36_note:           June 30 2026 deadline clearly confirmed for 50+ employee band from captured MoHRE 2026 source. 20–49 employee band: separate obligations confirmed (1 UAE national in skilled job) but June 30 2026 applicability for this band NOT confirmed from captured 2026-specific source. All references to 20–49 employees as having a June 30 2026 deadline have been removed or softened.
```
...
archive_note:              After noindex: keep page accessible as historical record. Add note "This deadline has passed. The next Emiratisation deadline is 31 December 2026." Link to TAX-04 article when built.
```
...
```
primary_source_1:
  authority:        MoHRE — Ministry of Human Resources and Emiratisation
  url:              https://mohre.gov.ae/en/media-center/news/7/5/2026/mohre-30-june-deadline-for-achieving-emiratisation-targets-for-first-half-of-2026
  publication_date: 2026-05-07
  access_date:      2026-05-19
  source_type:      official_mohre_news
  recheck_before_publish: true

primary_source_2:
  authority:        MoHRE — Emiratisation targets guidance page
  url:              https://www.mohre.gov.ae/en/guidance-and-awareness-portal-new/emiratisation-targets
  access_date:      2026-05-19
  source_type:      official_mohre_guidance
  recheck_before_publish: true

source_ledger:            docs/content-drafts/source-ledgers/uae-mohre-compliance-2026-sources.md
verification_file:        docs/content-drafts/verification/uae-emiratisation-30-june-2026-source-check.md
```
...
UAE Emiratisation Deadline: 30 June 2026, MoHRE Confirms
...
**Char count:** 140 (under 160 limit ✓)

### Target keywords

```
target_keywords_en:
  - Emiratisation deadline June 2026
  - MoHRE Emiratisation 2026
  - Emiratisation target UAE private sector
  - UAE 50 employees Emiratisation
  - Emiratisation 20 to 49 employees
  - UAE national hiring requirement 2026
```

### Search intent

```
search_intent_en: Business owner or HR manager in the UAE looking to understand whether their company must meet the June 30 Emiratisation deadline and what the consequences of missing it are.
```
...
The 30 June 2026 Emiratisation deadline applies to private-sector companies with 50 or more employees. These companies must achieve 1% semi-annual growth in their Emiratisation rate in skilled jobs for the first half of 2026. Separate Emiratisation requirements apply to companies with 20 to 49 employees. Verify the applicable deadline for that band directly with MoHRE.

### Key facts table

| Fact | Detail | Source |
|------|--------|--------|
| Deadline | 30 June 2026 | MoHRE news, 7 May 2026 |
| Companies with 50+ employees | 1% semi-annual growth in Emiratisation rate in skilled jobs (equals 2% annual target) | MoHRE Emiratisation targets page |
| Companies with 20–49 employees | Separate Emiratisation requirement: at least 1 UAE national in a skilled job. Applicable 2026 deadline for this band not confirmed from the captured 2026-specific source. Verify with MoHRE | MoHRE Emiratisation targets page (threshold confirmed); June 30 2026 date not confirmed for this band |
| Companies under 20 employees | No obligation confirmed from official source | Not stated in MoHRE source |
| Financial contributions | Start from 1 July 2026 for non-compliant 50+ employee companies | MoHRE Emiratisation targets page |
| Contribution amount | Not published by MoHRE in a confirmed 2026-specific source | Verify with MoHRE |
| Scope | Private-sector companies | MoHRE |
| Free zone scope | Not confirmed from official source | Verify with MoHRE |
| Next cycle | 31 December 2026 | MoHRE (annual target) |

### Who this may affect

Private-sector companies with 50 or more employees operating in the UAE. The 30 June 2026 deadline confirmed from MoHRE sources applies to this category.

Companies with 20 to 49 employees: separate Emiratisation requirements apply to this band. The applicable 2026 deadline for this category has not been confirmed from the captured 2026-specific MoHRE source reviewed for this article. If your company has 20 to 49 employees, check the current Emiratisation requirements and deadlines directly with MoHRE.

Free zone companies: the MoHRE sources reviewed for this article do not confirm whether Emiratisation targets apply to free zone entities. Verify directly with MoHRE if your company is registered in a free zone.
...
This article connects to a calendar reminder item for 30 June 2026 with `type: compliance_deadline`. The calendar item detail URL will be `/news/uae-emiratisation-june-30-2026-deadline` (this article). When the December 31 article is created (TAX-04), it should link to this article as historical reference.

See: `docs/content-drafts/calendar/uae-emiratisation-june-30-2026-reminder.md`

### Service / CTA guidance

**WhatsApp CTA placement:** After the "What business owners should check" section and again at the bottom of the article.

**CTA text (EN):** "Not sure whether your company's Emiratisation headcount is on track? We can connect you with a specialist who knows the current MoHRE requirements."

**CTA type:** Path A (WhatsApp consultation) and Path G (HR/compliance advisory referral)

**Do not use:** "Guaranteed compliance" or "We will handle your Emiratisation" — Guidex connects users to advisers, it does not provide compliance guarantee.
...
Срок Emiratisation 30 июня 2026: требования MoHRE для компаний

**Char count:** 62 (under 65 limit ✓)
...
**Char count:** 138 (under 160 limit ✓)

### RU target keywords

```
target_keywords_ru:
  - Emiratisation срок июнь 2026
  - MoHRE Emiratisation 2026
  - Emiratisation цели частный сектор ОАЭ
  - ОАЭ найм граждан 50 сотрудников
  - Emiratisation 20 49 сотрудников
```

### RU search intent

```
search_intent_ru: Владелец бизнеса или HR-менеджер в ОАЭ хочет узнать, распространяется ли на их компанию срок Emiratisation 30 июня 2026 года и каковы последствия его несоблюдения.
```

### RU summary (1–2 sentences)
...
Срок Emiratisation 30 июня 2026 года распространяется на компании частного сектора с 50 и более сотрудниками. Эти компании обязаны увеличить долю граждан ОАЭ на квалифицированных должностях на 1% за первое полугодие 2026 года. Для компаний с 20–49 сотрудниками действуют отдельные требования по Emiratisation. Уточните применимый срок 2026 года непосредственно в MoHRE.
...
| Сфера действия | Компании частного сектора | MoHRE |
| Свободные зоны | Не подтверждено официально | Уточнить в MoHRE |
| Следующий срок | 31 декабря 2026 | MoHRE |

### RU who this may affect
...
### RU what business owners should check
...
"Не уверены, соответствует ли ваша компания требованиям Emiratisation? Мы можем связать вас со специалистом, знакомым с актуальными требованиями MoHRE."
...
**EN:**
MoHRE has confirmed 30 June 2026 as the semi-annual Emiratisation target deadline for private-sector companies with 50 or more employees. These companies must achieve 1% growth in their Emiratisation rate in skilled jobs in the first half of 2026, equivalent to the 2% annual target. Financial contributions begin from 1 July 2026 for companies that do not meet the deadline. The specific contribution amount has not been confirmed from a 2026-specific official source. Scope is confirmed for private-sector mainland companies with 50 or more employees. Separate Emiratisation requirements apply to companies with 20 to 49 employees. The applicable 2026 deadline for that band should be verified with MoHRE. Free zone company scope is not confirmed from official sources. Source: MoHRE news, 7 May 2026, and MoHRE Emiratisation targets page.

**RU:**
MoHRE подтвердил 30 июня 2026 года как полугодовой срок Emiratisation для компаний частного сектора с 50 и более сотрудниками. Эти компании обязаны увеличить долю граждан ОАЭ на квалифицированных должностях на 1% в первом полугодии 2026 года (2% в год). Финансовые взносы начисляются с 1 июля 2026 года для невыполнивших норму. Конкретная сумма взносов за 2026 год официально не подтверждена. Сфера действия охватывает компании материкового частного сектора с 50 и более сотрудниками. Для компаний с 20–49 сотрудниками действуют отдельные требования. Применимый срок 2026 года для этой категории следует уточнить в MoHRE. Применимость к свободным зонам официально не подтверждена. Источник: MoHRE, новость от 7 мая 2026; страница целей Emiratisation.

---

## Blocked claims (internal — must not appear in published copy)
...
| "All UAE companies must meet Emiratisation targets" | Only companies with 50+ employees for this June 30 deadline; 20–49 band has separate requirements |
...
| "Free zone companies must meet Emiratisation targets" | Scope for free zone companies not confirmed from official source |
| "Free zone companies are exempt" | Equally not confirmed in either direction |
| "All roles count toward Emiratisation" | Skilled job definition not fully specified in captured sources |
| "Companies below 20 employees have obligations" | No official source confirms this |
| "This is HR or legal advice" | Guidex is an information resource |
...
| Copy or close-paraphrase of MoHRE text | Original writing required |

---

## Admin import notes (for when ready)

When this file moves to `owner_review_ready` and the owner approves:

1. Use `scripts/` or admin UI to create a new news post draft
2. Slug: `uae-emiratisation-june-30-2026-deadline`
3. Category: `government` (or `compliance` if that category is added)
4. Source label: `official`
5. Source URL: MoHRE news page (7 May 2026) — recheck URL is live before import
6. `noindex`: 0 (allow indexing; `noindex_after` logic will be applied via lifecycle at archive time)
7. `ru_published`: 1 (RU is complete)
8. Set `date_published` to the actual publish date
9. After import: run eid-summary-fix pattern to verify summaries are correct in DB
10. After publish: verify `robots: index, follow` on both EN and RU pages
11. After July 10 archive: set `noindex: 1` and update page to reference December 31 cycle article (TAX-04)

**Recheck before import:**
- Confirm both MoHRE URLs are still live
- Confirm the 30 June 2026 deadline has not been extended or cancelled
- Confirm no official contribution amount has been published (if it has, update the article before import)

---

*Status: owner_review_ready — 2026-05-20 (Phase 6C-36 final QA complete).*
*Phase 6C-36 change: Article refocused. June 30 2026 deadline asserted only for 50+ employee band. 20–49 band referenced with explicit "verify with MoHRE" direction — not stated as having a June 30 deadline.*
*Risk level: high — employment/compliance topic. Do not publish without owner approval and source recheck.*
