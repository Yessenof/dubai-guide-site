...
const CTA_EN: Record<string, string> = {
  holiday:              "Details →",
  government_deadline:  "Read guide →",
  tax_deadline:         "Read guide →",
  aml_deadline:         "Read guide →",
  event:                "View event →",
  real_estate_event:    "View event →",
  business_event:       "View event →",
  family_school:        "Details →",
  relocation:           "Read guide →",
  news_update:          "Read update →",
  guide_update:         "Read guide →",
  calendar_visual_post: "Open →",
};
const CTA_RU: Record<string, string> = {
  holiday:              "Подробнее →",
  government_deadline:  "Читать →",
  tax_deadline:         "Читать →",
  aml_deadline:         "Читать →",
  event:                "Смотреть →",
  real_estate_event:    "Смотреть →",
  business_event:       "Смотреть →",
  family_school:        "Подробнее →",
  relocation:           "Читать →",
  news_update:          "Читать →",
  guide_update:         "Читать →",
  calendar_visual_post: "Открыть →",
};
