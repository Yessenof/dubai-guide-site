// Adds Russian content to the existing child-dependent-visa-dubai-outside-country guide.
...
// Run with: npx tsx scripts/add-ru-child-dependent-visa-outside.ts

import Database from "better-sqlite3";
import path from "path";

const SLUG           = "child-dependent-visa-dubai-outside-country";
...
const RU_GUIDE = {
  ru_title:
    "Виза ребёнку в Дубае из-за пределов ОАЭ: entry permit и residence",
  ru_summary:
    "Для спонсоров, чей ребёнок находится за пределами ОАЭ. " +
    "Ребёнок въезжает по entry permit, после чего оформляются Emirates ID и residence visa.",
  ru_audience:
    "Резиденты Дубая, работающие в частном секторе, free zone или государственном секторе, " +
    "спонсирующие ребёнка, который сейчас за пределами ОАЭ.",
  ru_overview:
    "Спонсор, чей ребёнок находится за пределами ОАЭ, подаёт заявку на entry permit через Amer. " +
    "Ребёнок въезжает в Дубай по этому разрешению, после чего Emirates ID и residence visa " +
    "оформляются уже после прибытия. Медицинский осмотр на стандартном детском маршруте не требуется.\n\n" +
    "Суммарные государственные сборы составляют около AED 1,586 и включают открытие family file, " +
    "entry permit, Emirates ID и residence visa. Расходы на аттестацию документов за рубежом " +
    "оплачиваются отдельно и зависят от страны. Закладывайте от 3 до 6 недель в целом: " +
...
const RU_STEPS = [
  {
    ...
    ru_warning:
      ...
      "где находится ребёнок, прежде чем начинать.",
  },
  {
    step_order: 2,
  ...
  },
  {
    ...
    ru_what:
      "Amer подаёт заявку на entry permit ребёнка в ICP от имени спонсора. " +
      "После одобрения разрешение выдаётся в электронном виде.",
    ru_where:   "Amer",
    ru_address: "Любое отделение Amer в Дубае",
    ru_advice:
      "Перешлите entry permit тому, кто находится с ребёнком за рубежом. " +
      "Он потребуется при регистрации на рейс и при прохождении пограничного контроля ОАЭ.",
    ru_warning:
      "У entry permit есть срок действия. " +
      "Ребёнок должен въехать до его окончания: проверьте дату при получении.",
  },
  {
    step_order: 4,
    ru_title:   "Ребёнок въезжает в ОАЭ",
    ru_what:
      "Ребёнок прилетает в Дубай и предъявляет entry permit на паспортном контроле по прибытии.",
    ru_where:   "Пункт въезда в ОАЭ",
    ru_address: "Международный аэропорт Дубая (DXB) или другой пункт въезда в ОАЭ",
    ru_advice:
      "Распечатайте или сохраните цифровую копию entry permit перед поездкой. " +
  ...
  },
  {
    ...
    ru_what:
      "Спонсор завершает оформление residence visa через Amer. " +
