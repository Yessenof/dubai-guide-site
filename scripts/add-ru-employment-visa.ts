...
> = {
  ...
  3: {
    ...
    ru_what:
      ...
      "Разрешает смену статуса на рабочий резидентский без выезда из ОАЭ.",
  ...
  7: {
    ...
    ru_what:
      ...
      "Квалифицированные сотрудники (категория 1/2) идут в Tasheel, сотрудники категории 3 идут в Tawjeeh.",
