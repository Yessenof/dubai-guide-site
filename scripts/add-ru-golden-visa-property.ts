...
> = {
  1: {
    ...
    ru_advice:
      ...
      "Для off-plan или ипотечных объектов могут потребоваться дополнительные документы. Уточните в DLD до подачи.",
    ru_warning: "",
  },
  2: {
  ...
  7: {
    ...
    ru_advice:
      "На каждого члена семьи оформляется отдельный файл. " +
