/**
 * Phase 6C-95B -- UAE Calendar Batch 1 Local Import
 * LOCAL DEVELOPMENT ONLY -- do NOT run against production.
 *
 * What this script does:
 *   1. Adds new items to existing monthly calendar pages (Aug, Sep, Oct, Nov 2026)
 *   2. Creates December 2026 calendar page (slug: december-2026-uae-calendar)
 *
 * Items added:
 ...
 *   OCT-05-MIDTERM   School mid-term break UAE (Oct 12-18)
 ...
 *   DEC-04-GITEX     GITEX Global 2026 (Dec 7-11)
 *   DEC-05-WINBRK    School winter break (Dec 14)
 *
 * HOLD (not imported):
 *   The Corrs Sep -- exact date unconfirmed
 *   VAT Q3 deadline Nov -- FTA date unverified
 *   DFC -- site 403
 *   Global Village -- no opening date
 *   DSF Dec -- official dates not yet released
 *   RISE Expo Oct -- single source only
 *
 * Run: npx tsx scripts/import-uae-calendar-batch-1-local-6c95b.ts
 */
...
section("Phase 6C-95B -- UAE Calendar Batch 1 Local Import");
...
const NEW_ITEMS: DateItem[] = [
  ...
  // ---- AUG-04-BACKSCH: Back to School UAE 2026 ----------------------------
  {
    id:              "AUG-04-BACKSCH",
    date:            "2026-08-31",
  ...
  // ---- AUG-05-MICHAEL: This Is Michael, Etihad Arena Abu Dhabi ------------
  {
    id:              "AUG-05-MICHAEL",
    date:            "2026-08-22",
  ...
  // ---- SEP-09-AGUILERA: Christina Aguilera, Etihad Arena Abu Dhabi --------
  {
    id:              "SEP-09-AGUILERA",
    date:            "2026-09-25",
  ...
  // ---- SEP-10-OAKENFOLD: Paul Oakenfold, The Agenda Dubai -----------------
  {
    id:              "SEP-10-OAKENFOLD",
    date:            "2026-09-18",
  ...
  // ---- OCT-05-MIDTERM: UAE school mid-term break --------------------------
  {
    id:              "OCT-05-MIDTERM",
    date:            "2026-10-12",
    ...
    priority:        2,
    detail_url:      null,
    brief_en:        "UAE private schools break for mid-term from 12 to 18 October 2026. Schools reopen on Monday 19 October 2026. This applies to most private schools in Dubai, Abu Dhabi and other emirates; some schools may vary by one day. Source: KHDA official academic calendar 2026-2027.",
  ...
  // ---- OCT-06-MARX: Richard Marx, Coca-Cola Arena Dubai -------------------
  {
    id:              "OCT-06-MARX",
    date:            "2026-10-05",
    ...
    priority:        3,
    detail_url:      null,
    brief_en:        "Richard Marx performs live at Coca-Cola Arena, Dubai on 5 October 2026. Tickets available at the Coca-Cola Arena official website. The arena is located in City Walk, Dubai.",
  ...
  // ---- NOV-05-SIBF: Sharjah International Book Fair -----------------------
  {
    id:              "NOV-05-SIBF",
    date:            "2026-11-04",
...
// December items are in DECEMBER_DATES_JSON below.

// ---- Pre-flight: em dash check on all new items -------------------------
...
log("  All new item strings clean -- no em dashes found.");

// ---- December 2026 calendar page strings ---------------------------------
...
const DEC_EN_TITLE =
  "December 2026 in Dubai and the UAE: National Day, F1 Abu Dhabi and GITEX";

const DEC_RU_TITLE =
  "Декабрь 2026 в Дубае и ОАЭ: День независимости, Гран-при Абу-Даби и GITEX";
...
const DEC_EN_SEO_TITLE =
  "December 2026 UAE Calendar: National Day, F1 Abu Dhabi and GITEX";

const DEC_RU_SEO_TITLE =
  "Декабрь 2026 ОАЭ: День независимости, Гран-при Абу-Даби и GITEX";
...
const DEC_SOURCE_URL = "https://www.abudhabigp.com/en/";

// ---- December DATES_JSON -------------------------------------------------

const DECEMBER_DATES_JSON = JSON.stringify([

  // DEC-01-COMMEM: UAE Commemoration Day
  {
    id:              "DEC-01-COMMEM",
    date:            "2026-12-01",
    ...
    priority:        1,
    detail_url:      null,
    brief_en:        "UAE Commemoration Day (1 December) honours UAE soldiers who died in service. It is an official public holiday: government offices, schools, banks and most private businesses are closed. A day of reflection and national ceremonies.",
  ...
  // DEC-02-NATDAY: UAE National Day
  {
    id:              "DEC-02-NATDAY",
    date:            "2026-12-02",
    ...
    priority:        1,
    detail_url:      null,
    brief_en:        "UAE National Day is a 2-day public holiday on 2-3 December, marking the founding of the UAE in 1971. Expect citywide celebrations, fireworks, parades and national events across all seven emirates. Government, schools and most businesses are closed. With Friday 4 December following, residents may enjoy a 3-4 day break.",
  ...
  // DEC-03-F1: Formula 1 Abu Dhabi Grand Prix
  {
    id:              "DEC-03-F1",
    date:            "2026-12-04",
    ...
    priority:        1,
    detail_url:      null,
    brief_en:        "Formula 1 Etihad Airways Abu Dhabi Grand Prix 2026 takes place 4-6 December at Yas Marina Circuit, Abu Dhabi. Season finale of the 2026 Formula 1 World Championship. Practice: December 4-5; qualifying: December 5; race: Sunday December 6. Abu Dhabi is approximately 130 km from Dubai.",
    brief_ru:        "Гран-при Абу-Даби Формулы-1 2026 -- 4-6 декабря на трассе Yas Marina Circuit, Абу-Даби. Финальный этап чемпионата мира Формулы-1 2026. Практика: 4-5 декабря; квалификация: 5 декабря; гонка: воскресенье 6 декабря. Абу-Даби -- около 130 км от Дубая.",
  ...
  // DEC-04-GITEX: GITEX Global 2026
  {
    id:              "DEC-04-GITEX",
    date:            "2026-12-07",
    ...
    priority:        1,
    detail_url:      null,
    brief_en:        "GITEX Global 2026 runs 7-11 December at Expo City Dubai (Dubai Exhibition Centre) -- a new venue from 2026. The world's largest annual tech, AI and startup event. Over 6,000 exhibitors and 180,000+ attendees expected. New December timing puts GITEX in the heart of Dubai's tourism season.",
    brief_ru:        "GITEX Global 2026 -- 7-11 декабря в Expo City Dubai (Dubai Exhibition Centre). Смена площадки с 2026 года. Крупнейшее в мире ежегодное мероприятие по технологиям, ИИ и стартапам. Ожидается более 6000 экспонентов и 180 000+ посетителей. Декабрьский период совпадает с пиком туристического сезона Дубая.",
  ...
  // DEC-05-WINBRK: School winter break
  {
    id:              "DEC-05-WINBRK",
    date:            "2026-12-14",
    ...
    priority:        2,
    detail_url:      null,
    brief_en:        "UAE private school winter break begins 14 December 2026. Schools reopen 4 January 2027. This applies to most private schools in Dubai, Abu Dhabi and other emirates. Individual schools may vary by 1-2 days. Source: KHDA official academic calendar 2026-2027.",
...
// ---- Pre-flight: em dash check on December strings -----------------------

const DEC_STRINGS: Array<[string, string]> = [
  ["DEC_EN_TITLE",      DEC_EN_TITLE],
  ["DEC_RU_TITLE",      DEC_RU_TITLE],
  ["DEC_EN_SUMMARY",    DEC_EN_SUMMARY],
  ["DEC_RU_SUMMARY",    DEC_RU_SUMMARY],
  ["DEC_EN_BODY",       DEC_EN_BODY],
  ["DEC_RU_BODY",       DEC_RU_BODY],
  ["DEC_EN_NOTES",      DEC_EN_NOTES],
  ["DEC_RU_NOTES",      DEC_RU_NOTES],
  ["DEC_EN_SEO_TITLE",  DEC_EN_SEO_TITLE],
  ["DEC_RU_SEO_TITLE",  DEC_RU_SEO_TITLE],
  ["DEC_EN_META",       DEC_EN_META],
  ["DEC_RU_META",       DEC_RU_META],
  ["DECEMBER_DATES_JSON", DECEMBER_DATES_JSON],
];
for (const [label, value] of DEC_STRINGS) {
  assertNoEmDash(label, value);
}
log("  All December strings clean.");

// ---- Pre-flight: slug pre-existence check --------------------------------

section("Pre-flight: slug existence check");

const allCalPages = getAllCalendarPages();
const existingDecPage = allCalPages.find(p => p.slug === DEC_SLUG);
if (existingDecPage) {
  console.error(`\nABORT: December page "${DEC_SLUG}" already exists (id=${existingDecPage.id}).`);
  console.error("       Delete the existing row or re-run rollback before re-importing.");
  process.exit(1);
}
log(`  December page "${DEC_SLUG}": not found -- safe to create.`);
...
function mergeItems(existingJson: string, newItems: DateItem[]): string {
  ...
  if (skipped.length > 0) log(`    Skipped (already present): ${skipped.join(", ")}`);
...
const ITEMS_BY_SLUG: Record<string, DateItem[]> = {
  "august-2026-dubai-calendar": NEW_ITEMS.filter(x =>
    ["AUG-04-BACKSCH", "AUG-05-MICHAEL"].includes(x.id)
  ),
  "september-2026-dubai-calendar": NEW_ITEMS.filter(x =>
    ["SEP-09-AGUILERA", "SEP-10-OAKENFOLD"].includes(x.id)
  ),
  "october-2026-dubai-calendar": NEW_ITEMS.filter(x =>
    ["OCT-05-MIDTERM", "OCT-06-MARX"].includes(x.id)
  ),
  "november-2026-dubai-calendar": NEW_ITEMS.filter(x =>
    ["NOV-05-SIBF"].includes(x.id)
  ),
};

// ---- Update existing monthly calendar pages ----------------------------
...
for (const [slug, newItems] of Object.entries(ITEMS_BY_SLUG)) {
  ...
  const page = allCalPages.find(p => p.slug === slug);
  if (!page) {
    console.error(`  ABORT: Calendar page "${slug}" not found. Cannot update.`);
    process.exit(1);
  }

  const mergedJson = mergeItems(page.datesJson, newItems);
  const updateResult = updateCalendarDraft(page.id, { dates_json: mergedJson });
  if (!updateResult.ok) {
    console.error(`  FAIL updateCalendarDraft for ${slug}:`, updateResult.errors);
    process.exit(1);
  }

  const pubResult = publishCalendar(page.id);
  if (!pubResult.ok) {
    console.error(`  FAIL publishCalendar for ${slug}:`, pubResult.errors);
    process.exit(1);
  }
...
const decResult = createCalendarDraft({
  ...
  year:                DEC_YEAR,
  month:               DEC_MONTH,
  en_title:            DEC_EN_TITLE,
  en_summary:          DEC_EN_SUMMARY,
  en_body:             DEC_EN_BODY,
  en_notes:            DEC_EN_NOTES,
  en_seo_title:        DEC_EN_SEO_TITLE,
  en_meta_description: DEC_EN_META,
  ru_published:        1,
  ru_title:            DEC_RU_TITLE,
  ru_summary:          DEC_RU_SUMMARY,
  ru_body:             DEC_RU_BODY,
  ru_notes:            DEC_RU_NOTES,
  ru_seo_title:        DEC_RU_SEO_TITLE,
  ru_meta_description: DEC_RU_META,
  ...
  official_source_url: DEC_SOURCE_URL,
});

if (!decResult.ok) {
  console.error("  FAIL createCalendarDraft December:", decResult.errors);
  process.exit(1);
}
...
if (!decPub.ok) {
  console.error("  FAIL publishCalendar December:", decPub.errors);
  process.exit(1);
}
log(`  Published. Warnings: ${decPub.warnings.length ? decPub.warnings.join("; ") : "none"}`);
totalNewItems += 5; // 5 December items

// ---- Post-import verification ------------------------------------------

section("Post-import verification");

const allPagesAfter = getAllCalendarPages();

for (const slug of Object.keys(ITEMS_BY_SLUG)) {
  const page = allPagesAfter.find(p => p.slug === slug);
  if (!page || page.status !== "published") {
    console.error(`  FAIL: ${slug} not found or not published after update.`);
    process.exit(1);
  }
  const count = (JSON.parse(page.datesJson) as unknown[]).length;
  log(`  ${slug}: status=${page.status}, items=${count} PASS`);
}

const decPageAfter = allPagesAfter.find(p => p.slug === DEC_SLUG);
if (!decPageAfter || decPageAfter.status !== "published") {
  console.error(`  FAIL: ${DEC_SLUG} not found or not published.`);
  process.exit(1);
}
const decItemCount = (JSON.parse(decPageAfter.datesJson) as unknown[]).length;
log(`  ${DEC_SLUG}: status=${decPageAfter.status}, items=${decItemCount} PASS`);
...
PAGES UPDATED (existing, items added):
  august-2026-dubai-calendar   +2 items (AUG-04-BACKSCH, AUG-05-MICHAEL)
  september-2026-dubai-calendar +2 items (SEP-09-AGUILERA, SEP-10-OAKENFOLD)
  october-2026-dubai-calendar  +2 items (OCT-05-MIDTERM, OCT-06-MARX)
  november-2026-dubai-calendar +1 item  (NOV-05-SIBF)

PAGE CREATED (new):
  slug=${DEC_SLUG}
  id=${decId}
  url=/calendar/${DEC_SLUG}
  ru_url=/ru/calendar/${DEC_SLUG}
  month=12 year=2026 type=monthly
  items=${decItemCount} (DEC-01-COMMEM, DEC-02-NATDAY, DEC-03-F1, DEC-04-GITEX, DEC-05-WINBRK)

TOTAL NEW CALENDAR ITEMS: ${totalNewItems}

HOLD (not imported):
  The Corrs Sep -- exact date unconfirmed
  VAT Q3 Nov deadline -- FTA date unverified
  DFC -- site 403
  Global Village -- no opening date
...
ROLLBACK (local only):
  sqlite3 data/guides.db "DELETE FROM calendar_pages WHERE slug='${DEC_SLUG}';"
  -- For updated months: you would need to manually restore their dates_json from backup
  -- Or restore from: data/guides.db.backup-* (most recent pre-6c95b file)

LOCAL ONLY. No push. No deploy. No production DB write.
Production import requires separate owner approval (Phase 6C-95C or 6C-95D).
`);
