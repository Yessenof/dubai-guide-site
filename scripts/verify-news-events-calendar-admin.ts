...

{
  const r = validateEventPublish({
    ...
    en_body: "UAE National Day marks the unification of the seven emirates. Government offices, banks, and most businesses are closed.",
    en_seo_title: "UAE National Day 2026",
    en_meta_description: "UAE National Day falls on December 2, 2026. A public holiday across the UAE.",
